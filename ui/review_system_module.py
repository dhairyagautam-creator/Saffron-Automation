...
from ui.review_uploads_page import ReviewUploadsPage
...
class ReviewSystemModule(ctk.CTkFrame):
    """The Review System module: a branded left sidebar and a page content
    ...
    def on_show(self) -> None:
        ...
        self.show_page(self.active_page or "Uploads")
    ...
    def _build_sidebar(self, parent) -> None:
        ...
        ctk.CTkLabel(
            title_box, text="Review System", font=Font.SMALL, text_color=Color.TEXT_SECONDARY, anchor="w"
        ).pack(anchor="w")
    ...
    def _build_pages(self, parent) -> None:
        ...
        self.pages["Uploads"] = ReviewUploadsPage(container)
